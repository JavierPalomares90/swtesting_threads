            ...
            switch(protocol){
                case "U":
                    ...
                    while(true){
                        ...
                        //Spawn off a UDP ServerThread instance to process and reply to the received packet
                ...
                case "T":
                    ...
                    while(true){
                        ...
                        //Spawn off a TCP ServerThread instance to read the buffer from the connection which was just accepted
